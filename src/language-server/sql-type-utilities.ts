...
export function computeTypeOfNumericLiteral(text: string): TypeDescriptor | undefined {
...
export function computeTypeOfBinaryOperation(operator: BinaryExpression['operator'], left: TypeDescriptor, right: TypeDescriptor): TypeDescriptor | undefined {
  switch(operator) {
    case "+":
    case "-":
    case "/":
